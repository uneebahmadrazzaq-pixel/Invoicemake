...
test("invoice preview shows only the template without dark side gutters", async () => {
  ...
  assert.match(editorHtml, /dashboard-light\.css\?v=20260802-qogita-layout-fidelity-v46/);
  assert.match(page, /editor\/index\.html\?v=20260802-qogita-layout-fidelity-v46/);
