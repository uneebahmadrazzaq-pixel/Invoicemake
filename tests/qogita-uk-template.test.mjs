...
test("Qogita UK is an editable A4 invoice matching the supplied reference", async () => {
  ...
  assert.match(styles, /font-family:\s*Arial, Helvetica, sans-serif/);
  ...
  assert.match(styles, /\.qogita-uk-invoice,\s*\.qogita-uk-invoice \*\s*\{[\s\S]*font-family:\s*Arial, Helvetica, sans-serif !important/);
  ...
  assert.match(dashboardStyles, /body\.dashboard-light \.view \.qogita-uk-invoice \*[\s\S]*font-family:\s*Arial, Helvetica, sans-serif !important/);
